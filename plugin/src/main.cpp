...
**/
WUPS_PLUGIN_NAME("Inkay (Roséverse)");
WUPS_PLUGIN_DESCRIPTION("Pretendo Network Patcher (Uses Roséverse)");
WUPS_PLUGIN_VERSION(INKAY_VERSION);
WUPS_PLUGIN_AUTHOR("Pretendo contributors / Project Rosé Team");
